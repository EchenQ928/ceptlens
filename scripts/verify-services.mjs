...
try {
  ...
  const stem = typeof q.stem === 'string' ? q.stem : q.stem?.['zh-CN'] ?? q.stem?.['en-US'] ?? '';
  const reference = { resource: `question:${q.id}`, title: '服务验收', quote: stem.slice(0, 200), prefix: '', suffix: '', start: 0 };
