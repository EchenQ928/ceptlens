  ...
  return (
    <div className="page catalog-page">
      ...
      <section className="filter-panel">
        ...
        <details className="catalog-facets"><summary><SlidersHorizontal size={16}/>{uiText(locale,"按主题、层级与学习状态筛选","Filter by topic, level, and progress")}</summary><div className="facet-rows">
        ...
        </details><button className="advanced-trigger" aria-expanded={advanced} onClick={() => setAdvanced((value) => !value)}><SlidersHorizontal size={15} /> {uiText(locale, "高级筛选", "Advanced filters")} <ChevronDown size={14} className={advanced ? "rotated" : ""} /></button>
